...
public class Node2 {
	...
	public Node2() {
		...
		destLbl.setBounds(5, 105, 150, 25);
		frame.add(destLbl);

		destTxt = new JTextField();
		destTxt.setEditable(false);
		destTxt.setBounds(150, 105, 200, 25);
		frame.add(destTxt);

		msgLbl = new JLabel("Message");
		msgLbl.setBounds(5, 175, 150, 25);
		frame.add(msgLbl);

		msgTxt = new JTextField();
		msgTxt.setBounds(150, 175, 200, 25);
			...
			public void run() {
				try {
					do {
						...
						ServerSocket rcvSkt = new ServerSocket(1189);
	...
	public void hub1() {
		Thread router1 = new Thread(new Runnable() {
			public void run() {
				try {
					do {
						ServerSocket rcvSkt1 = new ServerSocket(2222);
